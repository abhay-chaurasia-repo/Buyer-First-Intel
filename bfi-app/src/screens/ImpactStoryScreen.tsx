  ...
  return (
    <div className="text-night-ink" data-testid="impact-snippet-size">
      ...
      <div className="mt-1 space-y-0.5 rounded-2xl border border-white/25 bg-transparent p-2">
        ...
        <p className="px-2 pb-1 pt-1 text-[11px] leading-snug text-night-faint">
          Compare with the listing. Size notes stay on this home’s checklist — not a community vote.
        </p>
      </div>
    </div>
  )
      ...
      <div className="rounded-2xl border border-white/25 bg-transparent p-3">
        <div className="grid grid-cols-2 gap-2">
          ...
          <div className="rounded-xl border border-white/25 bg-transparent px-3 py-2">
            ...
            <p className="mt-1 text-sm font-semibold text-night-ink">1</p>
  ...
  return (
    <div className="text-night-ink" data-testid="impact-snippet-community">
      <div className="rounded-2xl border border-white/25 bg-transparent p-3">
        ...
        <p className="mt-1 text-[11px] leading-snug text-night-faint">
          One form per buyer. Fixed fields only.
        </p>
        <div className="mt-2 space-y-2">
          {[
            { title: 'Noise during visit', value: 'Moderate' },
            { title: 'Parking', value: 'Limited' },
            { title: 'Basement', value: 'Unfinished' },
            { title: 'Moisture or musty odor', value: 'Not observed' },
          ].map((row) => (
            <div key={row.title} className="flex items-start justify-between gap-3">
              <span className="text-[12px] leading-snug text-night-muted">{row.title}</span>
