      ...
      <div className="relative flex flex-1 flex-col px-5 pb-6 pt-10 sm:px-8">
        <header className="animate-bfi-fade flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-action text-white shadow-sm">
          ...
          <span className="rounded-full border border-line bg-paper-elevated/80 px-3 py-1 text-xs font-medium text-ink-faint">
            Buyer-only
          </span>
        </header>
          ...
          >
            ...
            <div
              className={cn(
                ...
                isFocused
                  ? 'border-action ring-4 ring-action-soft'
                  : 'border-line-strong hover:border-ink-faint',
              )}
            >
              <Search className="ml-1 h-5 w-5 shrink-0 text-ink-faint" aria-hidden />
              <input
                id={inputId}
                type="search"
                value={query}
