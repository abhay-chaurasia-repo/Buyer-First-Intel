...
export function InAppBrowserScreen() {
  ...
  return (
    <AppShell contentClassName="relative min-h-0 overflow-hidden">
      <div className="flex min-h-0 flex-1 flex-col bg-paper">
        <header
          className="sticky top-0 z-20 shrink-0 border-b border-line bg-paper/95 backdrop-blur-md"
        ...
        >
          <div className="flex items-center gap-2 px-2 py-2">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="truncate text-[12px] text-ink-muted" title={url}>
                {host}
              </p>
            </div>
            <Link
              to="/guidance/buyer-commission-brief"
              className="shrink-0 rounded-full border border-saffron/25 bg-saffron-soft/90 px-2.5 py-1 text-[10px] font-semibold text-saffron-deep touch-manipulation"
            >
              Buyer brief
            </Link>
          </div>
        ...
        <div className="shrink-0 border-b border-line bg-saffron-soft/40 px-4 py-2.5">
          <p className="flex items-start gap-2 text-[12px] leading-relaxed text-ink-muted">
            <Scale className="mt-0.5 h-3.5 w-3.5 shrink-0 text-saffron" aria-hidden />
